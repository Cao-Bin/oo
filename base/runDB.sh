...
#docker run -it --network test --ip 172.18.0.207  -p 28080-28082:28080-28082 -p 9994-9996:9994-9996 -p 29994-29996:29994-29996 --cap-add SYS_PTRACE --hostname pinpoint --name pinpoint -v /opt/docker_volume/pinpoint:/pinpoint yous/pinpoint
