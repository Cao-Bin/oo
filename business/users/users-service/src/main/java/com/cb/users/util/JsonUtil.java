...
public final class JsonUtil {
    ...
    public static <T> String toJson(T obj) {
        return obj==null?null:JSON.toJSONString(obj, DEFAULT_FORMAT);
    }
     ...
     * @return
     */
    public static <T> List<T> toBeanList(String json, Class<T> targetClass) {
     ...
     * @return
     */
    public static <T> Set<T> toBeanSet(String json, Class<T> targetClass){
        if(StringUtils.isBlank(json)){
            return null;
        }
